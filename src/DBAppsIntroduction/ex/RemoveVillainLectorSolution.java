...
public class RemoveVillainLectorSolution {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        sqlConnection.setAutoCommit(false); //подобно на транзакция това е началото
        ...
        try (PreparedStatement releaseMinionsStatement =
            ...
            sqlConnection.commit(); //край, ако не се изпълнят вс неща ще има rollback
